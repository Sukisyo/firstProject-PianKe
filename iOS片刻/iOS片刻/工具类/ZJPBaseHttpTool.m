...
+ (instancetype)sharedClient{
    ...
    dispatch_once(&onceToken, ^{
        ...
        _sharedClient.responseSerializer.acceptableContentTypes = [NSSet setWithObjects:@"application/json",@"text/html",@"text/javascript",@"text/plain",@"application/x-javascript",@"charset=UTF-8", nil];
