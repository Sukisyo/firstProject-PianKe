...
@interface PKReadArticleNavigationBar ()
...
@implementation PKReadArticleNavigationBar
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        [_fontButton setImage:[UIImage imageNamed:@"fontImage"] forState:UIControlStateNormal];
...
- (void)layoutSubviews {
    ...
    [_fontButton mas_makeConstraints:^(MASConstraintMaker *make) {
        make.centerY.equalTo(ws.backButton.mas_centerY);
        make.left.equalTo(ws.line2.mas_right).offset(5);
    }];
