...
@interface PKReadDetailReadModel ()
@end
@implementation PKReadDetailReadModel
...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary
{
	...
	if(![dictionary[@"data"] isKindOfClass:[NSNull class]]){
		self.data = [[PKReadDetailReadData alloc] initWithDictionary:dictionary[@"data"]];
	}
