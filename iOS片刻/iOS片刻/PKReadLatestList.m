...
@interface PKReadLatestList ()
@end
@implementation PKReadLatestList
...
-(instancetype)initWithDictionary:(NSDictionary *)dictionary
{
	...
	if(![dictionary[@"counterList"] isKindOfClass:[NSNull class]]){
		self.counterList = [[PKReadLatestCounterList alloc] initWithDictionary:dictionary[@"counterList"]];
	}
	...
	if(![dictionary[@"userinfo"] isKindOfClass:[NSNull class]]){
		self.userinfo = [[PKReadLatestUserinfo alloc] initWithDictionary:dictionary[@"userinfo"]];
	}
